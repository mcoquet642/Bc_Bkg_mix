void bkg(){
//    std::vector<string> filelist = {"../test_bkg.root", "../test_prompt.root", "../test_nonprompt.root"};
//    std::vector<string> filelist = {"../test_bkg.root", "../test_prompt_01.root", "../test_nonprompt_01.root"};
    std::vector<string> filelist = {"../test_bkg.root", "../test_prompt.root", "../test_nonprompt_02.root"};
...
//    TFile f("bkg.root", "recreate");
//    TFile f("bkg_01.root", "recreate");
    TFile f("bkg_02.root", "recreate");
